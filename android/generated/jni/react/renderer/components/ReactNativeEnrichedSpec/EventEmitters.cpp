...
{
  auto highlight = jsi::Object(runtime);
  highlight.setProperty(runtime, "isActive", event.highlight.isActive);
  highlight.setProperty(runtime, "isConflicting", event.highlight.isConflicting);
  highlight.setProperty(runtime, "isBlocking", event.highlight.isBlocking);
...
payload.setProperty(runtime, "selectionEnd", event.selectionEnd);
{
  ...
  {
    auto highlight = jsi::Object(runtime);
    highlight.setProperty(runtime, "isActive", event.styleState.highlight.isActive);
    highlight.setProperty(runtime, "isConflicting", event.styleState.highlight.isConflicting);
    highlight.setProperty(runtime, "isBlocking", event.styleState.highlight.isBlocking);
