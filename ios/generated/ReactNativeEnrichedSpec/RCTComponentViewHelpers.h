...
if ([commandName isEqualToString:@"addHighlight"]) {
#if RCT_DEBUG
  if ([args count] != 3) {
    RCTLogError(@"%@ command %@ received %d arguments, expected %d.", @"EnrichedTextInputView", commandName, (int)[args count], 3);
    return;
...
if ([commandName isEqualToString:@"removeHighlight"]) {
#if RCT_DEBUG
  if ([args count] != 2) {
    RCTLogError(@"%@ command %@ received %d arguments, expected %d.", @"EnrichedTextInputView", commandName, (int)[args count], 2);
    return;
...
NSObject *arg1 = args[1];
  ...
  [componentView removeHighlight:start end:end];
  return;
}

if ([commandName isEqualToString:@"addFontSize"]) {
#if RCT_DEBUG
  if ([args count] != 3) {
    RCTLogError(@"%@ command %@ received %d arguments, expected %d.", @"EnrichedTextInputView", commandName, (int)[args count], 3);
    return;
...
#endif
  float size = [(NSNumber *)arg2 floatValue];

  [componentView addFontSize:start end:end size:size];
  return;
}

if ([commandName isEqualToString:@"removeFontSize"]) {
#if RCT_DEBUG
  if ([args count] != 2) {
    RCTLogError(@"%@ command %@ received %d arguments, expected %d.", @"EnrichedTextInputView", commandName, (int)[args count], 2);
    return;
...
if ([commandName isEqualToString:@"clearFormatting"]) {
#if RCT_DEBUG
  if ([args count] != 2) {
    RCTLogError(@"%@ command %@ received %d arguments, expected %d.", @"EnrichedTextInputView", commandName, (int)[args count], 2);
    return;
...
NSObject *arg1 = args[1];
  ...
  [componentView clearFormatting:start end:end];
  return;
}

if ([commandName isEqualToString:@"clearColors"]) {
#if RCT_DEBUG
  if ([args count] != 2) {
    RCTLogError(@"%@ command %@ received %d arguments, expected %d.", @"EnrichedTextInputView", commandName, (int)[args count], 2);
    return;
