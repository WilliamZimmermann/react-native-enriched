...
EnrichedTextInputViewProps::EnrichedTextInputViewProps(
    ...
    disableNativeSelectionMenu(convertRawProp(context, rawProps, "disableNativeSelectionMenu", sourceProps.disableNativeSelectionMenu, {false})),
...
folly::dynamic EnrichedTextInputViewProps::getDiffProps(
  ...
  if (disableNativeSelectionMenu != oldProps->disableNativeSelectionMenu) {
    result["disableNativeSelectionMenu"] = disableNativeSelectionMenu;
  }
