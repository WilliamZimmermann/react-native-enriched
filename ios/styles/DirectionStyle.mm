      ...
      enumerateAttribute:NSParagraphStyleAttributeName
              ...
              usingBlock:^(id _Nullable value, NSRange subRange,
                ...
                NSWritingDirection direction =
                    [DirectionUtils markerToDirection:marker];
                pStyle.baseWritingDirection = direction;
                [self.host.textView.textStorage
...
- (void)addDirection:(NSWritingDirection)direction
  ...
  NSString *value = [DirectionUtils directionToMarker:direction];
...
- (NSString *)getStyleState {
  ...
  NSWritingDirection currentDirection =
      [DirectionUtils markerToDirection:marker];
  return [DirectionUtils directionToString:currentDirection];
}
...
- (void)applyStylingToTypingAttrs:(NSMutableDictionary *)attributes {
  ...
  NSString *marker =
      [TextListsUtils firstTextListWithPrefix:[self getMarkerPrefix]
                                      inArray:pStyle.textLists]
          .markerFormat;
  NSWritingDirection direction = [DirectionUtils markerToDirection:marker];
  pStyle.baseWritingDirection = direction;
