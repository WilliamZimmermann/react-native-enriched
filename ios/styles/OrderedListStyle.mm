...
- (void)applyStyling:(NSRange)range {
  ...
  // margin before marker + gap between marker and paragraph; one unit per
  // nesting depth so indented items shift right and their markers sit in the
  // freed gutter
  CGFloat unit = [self.host.config orderedListMarginLeft] +
